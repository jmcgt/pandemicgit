...
namespace PandemicWeb.Controllers
{
    ...
    {        
        ...
        {
            HttpContext.Session.SetString("cliente_data", JsonConvert.SerializeObject(cliente));
        }
        ...
        public void SetPedidoSessao(Pedido pedido)
        {
            HttpContext.Session.SetString("pedido_data", JsonConvert.SerializeObject(pedido));
        }
